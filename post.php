      ...
      <script>
        ...
        function verCita() {
                      ...
                      switch (Servicio) {
                        ...
                        case "Unas": document.getElementById("verServicio").value = "Uñas de Acrilico"; break;
                      ...
                      if (acomp == true) {
                        if (prisa == true) {
                          document.getElementById("verExtra").value = "La persona llevara acompañante y tendra prisa";
                        }  else {
                          document.getElementById("verExtra").value = "La persona llevara acompañante";
                        }
                      } else {
                        if (prisa == true) {
          ...
          <div class="modal-dialog modal-confirm" style="background-color: #fff;">
            <div class="modal-content">
              <article class="card-body">
                ...
                <hr>
                <h3 class="text-success text-center">Por favor inicia sesion en la siguiente pestaña</h3>
                                ...
                                <div class="col-md-7 col-lg-8">
                                  ...
                                  <form class="needs-validation" novalidate="">
                                      ...
                                      <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                          <select class="form-select" id="slcServicio" required="" disabled>
                                            ...
                                            <option value="Unas">Uñas de Acrilico</option>
                                    ...
                                    <div class="form-check">
                                      ...
                                      <label class="form-check-label" for="save-info">Tendré prisa y necesito salir lo mas temprano psoible</label>
                                    </div>
